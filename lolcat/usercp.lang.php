...
$l['nav_usercp'] = "UR SETTINGZ";
$l['nav_profile'] = "CHANGE UR PROFILE";
$l['nav_options'] = "EDIT OPSHUNS";
$l['nav_email'] = "CHANGE EMAIL";
$l['nav_password'] = "EDIT PASSWORD";
$l['nav_changename'] = "NO LIEK NAME?";
$l['nav_subthreads'] = "UR FAV TOPIX";
$l['nav_forumsubscriptions'] = "UR BFF FORUMS";
$l['nav_editsig'] = "AFTUR POST STUFF";
$l['nav_avatar'] = "CAN I HAZ PIC";
$l['nav_notepad'] = "NOTEZ";
$l['nav_editlists'] = "EDIT UR FRENDZ AN ENEMIES";
$l['nav_drafts'] = "Y U NO POST THESE";
$l['nav_usergroups'] = "I CAN HAZ GROUP?";
$l['nav_attachments'] = "UR ATTACHMENTS";
$l['nav_addsubscription'] = "ADD FAVRITE";

$l['resend_activation'] = "I DIDNT GET EMAIL :(";
$l['away_notice_away'] = "UR BEN GONE SINCE {1}";
$l['away_notice'] = "PLZ DONT LEAVE :(";
$l['already_uploaded_avatar'] = "UR USING AVATAR ON R SRVER.. IF U UPLOAD ANOTHER, ITLL GO BAI.";
$l['na_deleted'] = "N/A - BEEN DELETD.";
$l['user_cp'] = "UR SETTINGZ";
$l['user_cp_welcome'] = "DIS IS UR SETTINGS. U CN EDIT UR PROFILE, FAVRITES, ND MSGZ.<br />MAIN PAEG HAS UR INFO.";
$l['account_summary'] = "UR ACCOUNT";
$l['username'] = "UR NAEM:";
$l['user_id'] = "USR ID:";
$l['title'] = "UR TITLE:";
$l['postnum'] = "POSTS:";
$l['posts_day'] = "({1} PER DAY | {2} % OF ALL POSTS)";
$l['additional_contact_details'] = "MORE CONTACT INFOZ";
$l['email'] = "EMAIL:";
$l['reputation'] = "UR REP:";
$l['website'] = "I CAN HAZ WEBSITES:";
$l['usergroup'] = "UR GRUPS:";
$l['birthday'] = "U WAS BORN WEN?";
$l['birthdayprivacy'] = "BDAY PRIVACY:";
