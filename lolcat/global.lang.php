...
$l['redirect_width'] = "50%";
$l['lastvisit_never'] = "NEVR";

$l['toplinks_memberlist'] = "PIPLZ";
$l['toplinks_search'] = "Search";
$l['toplinks_calendar'] = "CALNDAR";
$l['toplinks_help'] = "HLP PLZ!";
$l['toplinks_portal'] = "Portal";
$l['bottomlinks_contactus'] = "BOOP US";
$l['bottomlinks_returntop'] = "UP UP UP(^THAT WAY)";
...
$l['welcome_usercp'] = "UR SETTINGS";
$l['welcome_modcp'] = "Mod CP";
$l['welcome_admin'] = "Admin CP";
$l['welcome_logout'] = "LEAVE";
$l['welcome_login'] = "ENTR";
...
$l['forum_locked'] = "U CANT POST HERE";
...
$l['password_required'] = "U NEED A PASSWURD";
$l['forum_password_note'] = "U NEED A PASSWURD TO READ THIS";
$l['enter_password_below'] = "WUT'S THE PASSWURD?";
$l['verify_forum_password'] = "PASSWURD HERE.";
$l['wrong_forum_password'] = "LOL UR RONG. PLAY AGAIN?";

$l['reset_button'] = "Reset";
$l['username'] = "WUTS UR NAME:";
$l['username1'] = "WUTS UR EMAIL:";
$l['username2'] = "WUTS UR NAME OR EMAIL:";
$l['password'] = "U NEED A PASSWORD:";
...
$l['attachments_desc'] = "U can add a file. Boop button to upload, PLZ.";
...
$l['no_subscribe'] = "DO NOT WANT";
$l['no_email_subscribe'] = "DO NOT WANT EMAILS";
$l['instant_email_subscribe'] = "WANT EMAIL NAOW";
...
$l['editor_title_bold'] = "BOLD IT";
$l['editor_title_italic'] = "ITALIX IT";
$l['editor_title_underline'] = "UNDERLINE IT";
$l['editor_title_left'] = "MOVE IT LEFT";
$l['editor_title_center'] = "MOVE IT MIDDLE";
$l['editor_title_right'] = "MOVE IT RIGHT";
$l['editor_title_justify'] = "MAKE IT EVEN";
$l['editor_title_numlist'] = "LIST WITH NUMBERS";
$l['editor_title_bulletlist'] = "LIST WITH DOTS";
$l['editor_title_image'] = "PICS, PLZ?";
$l['editor_title_hyperlink'] = "LINK, PLZ?";
$l['editor_title_email'] = "EMAIL, PLZ?";
$l['editor_title_quote'] = "QUOTE, PLZ?";
$l['editor_title_code'] = "CODE, PLZ?";
$l['editor_title_php'] = "PHP, PLZ?";
$l['editor_title_close_tags'] = "CLOSE <i>ALL</i> THE CODE!";
$l['editor_enter_list_item'] = "WRITE UR FIRST ITEM. IF U DON'T WRITE, U CLOSE THE BOX.";
$l['editor_enter_url'] = "WRITE THE LINK, PLZ?";
$l['editor_enter_url_title'] = "WUT DO U WANT IT TO SAY?";
$l['editor_enter_email'] = "WUT'S THE ADRESS?";
$l['editor_enter_email_title'] = "Optionally, you may also enter a title for the email address.";
$l['editor_enter_image'] = "PIC LINK, PLZ.";
$l['editor_enter_video_url'] = "VIDEO LINK, PLZ.";
...
$l['editor_size_xx_small'] = "TINIEST";
$l['editor_size_x_small'] = "TINIER";
$l['editor_size_small'] = "TINY";
$l['editor_size_medium'] = "NORMAL";
$l['editor_size_large'] = "BIG";
$l['editor_size_x_large'] = "BIGGER";
$l['editor_size_xx_large'] = "BIGGEST";
$l['editor_font'] = "Font";
...
$l['postbit_status_online'] = "ON";
$l['postbit_status_offline'] = "OFF";
$l['postbit_status_away'] = "GONE";
...
$l['postbit_currently_ignoring_user'] = "U CAN'T SEE THIS BCUZ UR <a href=\"usercp.php?action=editlists\">IGNORING</a> {1}.";
...
$l['banned_lifted_never'] = "NEVR";
$l['banned_email_warning'] = "U CAN'T USE THAT EMAIL. CHANGE IT PLZ.";
...
$l['newpm_notice_one'] = "<strong>U'VE GOT MAIL/strong> {1} SENT U <a href=\"private.php?action=read&amp;pmid={2}\" style=\"font-weight: bold;\">{3}</a>";
$l['newpm_notice_multiple'] = "<strong>U'VE GOT {1} MAILZ.</strong> {2} SENT U <a href=\"private.php?action=read&amp;pmid={3}\" style=\"font-weight: bold;\">{4}</a> LAST.";
...
$l['error_banned'] = "LOL UR BANNED. U CAN'T DO ANYTHING. U CAN TALK TO THE ADMIN IF U DON'T LIKE IT.";
